...
//@Configuration
//@EnableWebSecurity
public class ApplicationSecurityConfigUserRolesAndPermissions  extends WebSecurityConfigurerAdapter{

	
	private PasswordEncoder passwordEncoder;
	
	@Autowired
	public ApplicationSecurityConfigUserRolesAndPermissions(PasswordEncoder passwordEncoder) {
